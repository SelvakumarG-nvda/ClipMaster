...
class ClipSpeakHistoryDialog(wx.Dialog):
    ...
    def on_char_hook(self, event):
        ...
        # Spacebar to toggle selection (Selected / Not selected)
...
class ClipManager(object):
    ...
    def _prompt_edit_shortcut(self, parent_dialog=None):
        ...
        dlg = wx.TextEntryDialog(parent, "Enter new shortcut key (e.g. `, control+shift+v):", "Edit Shortcut Key", self.toggle_shortcut)
